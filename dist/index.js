...
var MUTButton = function (props) {
    ...
    return (react.createElement("button", __assign({ className: classNames(styles[base], styles[base + "--type--" + type], styles[base + "--size--" + size], styles[base + "--variant--" + variant], (_a = {},
...
var MUTInput = function (props) {
    ...
    return (react.createElement("div", __assign({ className: classNames(styles$1[base], styles$1[base + "--" + props.radius + "--radius"], (_a = {},
            _a[styles$1[base + "--password"]] = props.password,
            _a[styles$1[base + "--" + props.fluid]] = props.fluid,
            _a)) }, wrapperProps),
        react.createElement("input", __assign({ placeholder: props.placeholder, type: isPW(), value: props.value, onChange: function (event) {
                inputOnChange && inputOnChange(event);
                props.onChange && props.onChange(event);
            } }, restInputProps)),
        props.password && (react.createElement("i", __assign({ onClick: function (event) {
                setVisible(!visible);
                props.onClick && props.onClick(event);
                iconOnClick && iconOnClick(event);
            } }, restIconProps), showPWText() ? (react.createElement(AiFillEye, { style: {
                fontSize: ICON_SIZE,
            } })) : (react.createElement(AiFillEyeInvisible, { style: {
                fontSize: ICON_SIZE,
            } }))))));
};
