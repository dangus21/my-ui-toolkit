...
export var MUTInput = function (props) {
    ...
    return (React.createElement("div", __assign({ className: cn(styles[base], styles[base + "--" + props.radius + "--radius"], (_a = {},
            _a[styles[base + "--password"]] = props.password,
            _a)) }, wrapperProps),
        ...
        props.password && (React.createElement("i", __assign({ onClick: function (event) {
            ...
            } }, restIconProps), showPWText() ? (React.createElement(VisibilityOutlined, { style: {
                fontSize: ICON_SIZE,
            } })) : (React.createElement(VisibilityOffOutlined, { style: {
                fontSize: ICON_SIZE,
            } }))))));
};
